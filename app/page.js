              ...
              <div className="col-lg-6">
                <div className="ts-intro">
                  ...
                  <p>
                    ...
                    accompagner dans vos projets, que ce soit pour votre
                    mobilité ou votre éducation. Nous sommes là pour vous offrir
                    des solutions adaptées et un service de qualité.
                  </p>
                </div>
                {/* Intro box end */}
              ...
              <div className="col-lg-4">
                <div className="ts-service-box d-flex">
                  ...
                  <div className="ts-service-box-info">
                    ...
                    <p>
                      ...
                      répond aux besoins de ses clients en matière d&apos;achat,
                      de construction, de vente ou de location de biens
                      immobiliers.
                    </p>
                  </div>
                </div>
                ...
                <div className="ts-service-box d-flex">
                  ...
                  <div className="ts-service-box-info">
                    ...
                    <p>
                      Notre entreprise d&apos;impression se spécialise dans la
                      conception et la réalisation de supports de communication
                      de qualité.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4 mt-5 mt-lg-0 mb-4 mb-lg-0">
                <div className="ts-service-box d-flex">
                  ...
                  <div className="ts-service-box-info">
                    ...
                    <p>
                      Notre entreprise se spécialise dans la gestion, la vente
                      et la location de tous types de véhicules et
                      d&apos;engins, offrant ainsi une solution complète pour
                ...
                <div className="ts-service-box d-flex">
                  ...
                  <div className="ts-service-box-info">
                    ...
                    <p>
                      Notre équipe pédagogique qualifiée et passionnée met tout
                      en œuvre pour soutenir les apprenants dans leur réussite
                      académique.
                    </p>
                  </div>
                </div>
